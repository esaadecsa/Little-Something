...
window.LIVING_STORY_CONFIG = {
  ...
  returnMessages: {
    firstVisit: {
      kicker: "WELCOME BACK · LITTLE UNIVERSE",
      title: "A little corner is still here. ♡",
      text: "Nggak perlu sering-sering datang. Tapi kalau suatu hari kamu butuh tempat kecil untuk bernapas, cerita ini masih menyimpan satu halaman untukmu."
    },
