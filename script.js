...
function applyCycleTheme(state) {
  ...
  if (state === "epilogue") {
    if (eyebrow) eyebrow.textContent = "BELUM SAATNYA ✦";
    ...
    if (reqCopy) reqCopy.innerHTML = "Halaman ini emang selalu ada, bukan cuma pas musim ulang tahun. Tapi kalau kamu udah punya PIN, itu jalan ke bagian yang lebih personal ✦";
    fireworksMode = "off";
  } else if (state === "countdown-close") {
    if (eyebrow) eyebrow.textContent = "SEBENTAR LAGI ✦";
    ...
    if (eyebrow) eyebrow.textContent = "MENUJU 1 SEPTEMBER ✦";
