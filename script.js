...
function finishCelebration() {
  ...
  setTimeout(() => { showScreen("giftmap"); playSfx("chime"); }, 850);
}
...
/* =========================================================
   ...
   PIN-gate testing sudah selesai. Registrasikan worker setelah load
   agar reload lebih stabil tanpa menahan versi HTML/JS lama.
   ========================================================= */
if ("serviceWorker" in navigator && !IS_LOCAL_DEV) {
  window.addEventListener("load", () => {
    navigator.serviceWorker.register("./sw.js", { scope: "./" })
      .then((registration) => registration.update())
      .catch(() => { /* worker gagal bukan alasan situs berhenti */ });
  });
}
