...
function goBehind() { showScreen("behind"); startCodeAnimation(); }
...
$("#endReplayBtn").onclick = () => {
  ...
  vibrate(12);
  document.body.classList.remove("celebrating", "final-cinematic");
  $("#endCloseState")?.setAttribute("hidden", "");
...
$("#endCloseBtn").onclick = () => {
  playSfx("tap");
  $(".end-actions")?.setAttribute("hidden", "");
  $("#endCloseState")?.removeAttribute("hidden");
};
$("#endReopenBtn").onclick = () => {
  playSfx("tap");
  $("#endCloseState")?.setAttribute("hidden", "");
  $(".end-actions")?.removeAttribute("hidden");
};
