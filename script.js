...
function showScreen(name) {
  ...
  if (name === "giftmap") {
    ...
    if (fill) {
      ...
      void fill.offsetWidth; // force reflow so the fill-in animation replays every visit
...
$("#giftmapNextBtn").onclick = () => { playSfx("tap"); showScreen("flower"); };
