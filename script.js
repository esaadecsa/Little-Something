...
function openMinigameMenu(){ $("#minigameMenu")?.classList.add("active"); $("#memoryGamePanel")?.classList.remove("active"); $("#bouquetGamePanel")?.classList.remove("active"); }
...
$("#bouquetChoice")?.addEventListener("click",()=>{playSfx("tap");showMiniPanel("#bouquetGamePanel");resetBouquetGame();});
$("#memoryBackBtn")?.addEventListener("click",()=>{playSfx("tap");openMinigameMenu();});
$("#bouquetBackBtn")?.addEventListener("click",()=>{playSfx("tap");openMinigameMenu();});
